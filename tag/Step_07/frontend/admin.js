...
function navConnexion(data, admin=false) {
    ...
    if(admin == false)
    {
        navCreator = '<div class="collapse navbar-collapse" id="navbarCollapse">'+
                            '<ul class="navbar-nav mr-auto">'+
                                '<li class="nav-item active">'+
                                    '<a class="navbar-brand" href="annonces.html">JobBoard</a>'+
                                '</li>'+
                            '</ul>'+
...
function getTable(table)
{
    ...
    tableCreator =  "<table class='table table-bordered table-striped'>"+
                        "<thead>"+
                            "<tr>"
...
//methode appeler lorsque l'admin veut modifier la ligne de la table
...
//methode qui est appeler lorsque l'admin confirm la modification
...
//methode qui envoie la modification de la ligne de la table
